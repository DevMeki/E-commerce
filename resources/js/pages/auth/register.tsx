                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input 
                                                ...
                                                className="w-full rounded-xl bg-brand-parchment border border-brand-forest/10 px-4 py-3 pr-10 text-sm focus:outline-none focus:border-brand-orange transition-all"
                                                placeholder="••••••••"
                                            />
                                            <button
                                                type="button"
